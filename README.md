...
## Blog
Checkout my blog I write about coding (c, odin, C#, ...), games, etc: ~~[dezashibi.com](https://dezashibi.com)~~ -> Offline for maintenance.
...
You can check out [here](https://github.com/orgs/4odin/repositories).

## Wanna see my codes with rust and some typescript/javascript game engines?
Check out [here](https://github.com/orgs/mopts-stack/repositories).

## Other
I've been using one or more of these since 15+ years ago
![My Skills](https://skillicons.dev/icons?i=cs,godot,c,rust,cpp,php,python,ts,js,svelte,tailwind,phaser)
